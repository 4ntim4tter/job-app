            ...
            <div class="row">
                        ...
                        <div class="d-flex mb-3">
                            <div class="d-flex flex-column bg-light px-3 overflow-auto"
                                ...
                                <div class="" style="font-size: 13px; padding-top: 2%">
                                    ...
                                    <span><b>Posted Jobs: {{ $company->jobs->count() }} </b></span>/
                                    <span><b>Open Jobs: {{ $company->jobs->where('open', 1)->count() }} </b></span>/
                                    <span><b>Closed Jobs: {{ $company->jobs->where('open', 0)->count() }} </b></span>
                                ...
                                <div class="py-2" style="scale: 0.8; position: absolute; bottom:0; right: 0;">
                ...
                <div class="py-4 px-4 mb-3 " style="display: inline; flex: 1; height:100vh;">
                    <div class="bg-light py-2 px-4 mb-3" style="margin-left: 6%">
                        <h3 class="m-0"><u>Company Stats</u></h3>
                    </div>
